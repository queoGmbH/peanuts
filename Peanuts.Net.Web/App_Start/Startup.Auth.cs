...
namespace Com.QueoFlow.Peanuts.Net.Web {
    public partial class Startup {
        public static TimeSpan cookieExpiration = TimeSpan.FromHours(2);
        ...
        public void ConfigureAuth(IAppBuilder app) {
            ...
            app.UseCookieAuthentication(new CookieAuthenticationOptions {
                ...
                /*Wenn der Nutzer in der Anwendung aktiv ist, wird er nicht abgemeldet.*/
                ...
                Provider = new CookieAuthenticationProvider {
                    ...
                    OnValidateIdentity = SecurityStampValidator.OnValidateIdentity<ApplicationUserManager, SecurityUser>(
