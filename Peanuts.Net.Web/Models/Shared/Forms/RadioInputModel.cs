...
namespace Com.QueoFlow.Peanuts.Net.Web.Models.Shared.Forms {
    public class RadioInputModel : ChoiceInputModel {
        /// <summary>
        /// </summary>
        ...
        public RadioInputModel(HtmlHelper htmlHelper, ModelMetadata modelMetaData, string propertyPath, string label)
