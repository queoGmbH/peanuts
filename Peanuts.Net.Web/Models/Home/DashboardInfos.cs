...
namespace Com.QueoFlow.Peanuts.Net.Web.Models.Home {
    public class DashboardInfos {
        ...
        public DashboardInfos(IPage<PeanutParticipation> todaysPeanuts, IPage<UserGroupMembership> memberships, IList<Core.Domain.Accounting.Bill> pendingBills, IPage<Core.Domain.Accounting.Bill> declinedBills, IPage<Core.Domain.Accounting.Payment> pendingPayments, IPage<Core.Domain.Accounting.Payment> declinedPayments) {
        ...
        public IPage<Core.Domain.Accounting.Bill> DeclinedBills {
            get; set;
        }
        ...
        /// </summary>
        public IPage<Core.Domain.Accounting.Payment> DeclinedPayments {
            get; set;
        }
        ...
        /// </summary>
        public IPage<UserGroupMembership> Memberships {
            get; private set;
        }
        ...
        /// </summary>
        public IList<Core.Domain.Accounting.Bill> PendingBills {
            get; private set;
        }
        ...
        /// </summary>
        public IPage<Core.Domain.Accounting.Payment> PendingPayments {
            get; private set;
        }
        ...
        /// </summary>
        public IPage<PeanutParticipation> TodaysPeanuts {
            get; private set;
        }
    }
}